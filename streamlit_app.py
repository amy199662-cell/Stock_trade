...
INDICATOR_OPTIONS = {
    "MA":   "MA - 移動平均線 (黃金交叉買進/MA>長天期MA，死亡交叉賣出/MA<長天期MA)",
    "KD":   "KD - 隨機指標 (K<20超賣買進/K向上穿越D，K>80超買賣出/K向下穿越D)",
    "RSI":  "RSI - 相對強弱指標 (RSI<30超賣買進/低檔背離，RSI>70超買賣出/高檔背離)",
    "MACD": "MACD - 指數平滑異同移動平均線 (OSC由綠翻紅/DIF上穿MACD買進，OSC由紅翻綠/DIF下穿MACD賣出)",
    "BB":   "BB - 布林通道 (股價觸及下軌買進/突破上軌加碼，股價觸及上軌賣出/跌破中軌停損)",
    "VOL":  "VOL - 成交量 (放量突破買進/價漲量增，爆量不漲賣出/價跌量增)",
    "BIAS": "BIAS - 乖離率 (BIAS<-5%負乖離過大買進，BIAS>+5%正乖離過大賣出)",
    "DMI":  "DMI - 動向指標 (+DI向上穿越-DI買進，+DI向下穿越-DI賣出)",
    "WR":   "WR - 威廉指標 (WR<-80超賣買進，WR>-20超買賣出)",
    "OBV":  "OBV - 能量潮指標 (OBV創新高/突破壓力線買進，OBV創新低/跌破支撐線賣出)",
}
BLANK_OPTION = "（不使用）"
